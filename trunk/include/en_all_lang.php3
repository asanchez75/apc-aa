...
define("CONFIG_FILE", "en_all_lang.php3");
...
define("L_LINK_ONLY", "External link");
define("L_HL_HREF", "External link URL");
...
define("L_HLP_HDLN_URL",'alias for Item URL<br>(substituted by Outer link URL(if Outer link is checked) or link to Fulltext)<div class=example><em>Example: </em>&lt;a href=_#HDLN_URL&gt;_#HEADLINE&lt;/a&gt;</div>');
...
define("L_HLP_ABSTRACT",'alias for Abstract<br>(if there is no abstract in database, first Grab_length characters from Fulltext are used)');
define("L_HLP_FULLTEXT",'alias for Fulltext<br>(HTML tags are striped or not depending on HTML formated item setting)');
define("L_HLP_IMAGESRC",'alias for Image URL<br>(if there is no image url defined in database, default url is used instead (see NO_PICTURE_URL constant in en_*_lang.php3 file (transparent pixel, maybe)))<div class=example><em>Example: </em>&lt;img src="_#IMAGESRC"&gt;</div>');
...
define("L_HLP_POSTEDBY",'alias for Posted By (author)');
define("L_HLP_E_POSTED",'alias for E-mail (of author)');
define("L_HLP_CREATED",'alias for Created By');
...
define("L_HLP_ITEM_ID",'alias for Item ID<br>(can be used as paramter sh_itm= given to slice.php3 (or to any .shtml file, which this script includes))');
...
define("L_MSG_PAGE", "Toolkit message");   // title of message page
define("L_EDITOR_TITLE", "Editor window - item management");
...
/*
$Log$
Revision 1.18  2000/12/05 14:01:18  honzam
...
Revision 1.13  2000/08/17 15:19:01  honzam
...
Revision 1.1.1.1  2000/06/21 18:40:30  madebeer
