...
define("CONFIG_FILE", "cz_media_lang.php3");
...
define("DEFAULT_CATEGORY_SORT", false);
...
define("L_HIGHLIGHT", "Zajímavý èlánek");
...
define("L_CREATED_BY","Vyplnil");
define("L_LASTEDIT","Naposled editoval");
define("L_AT","dne");   
define("L_EDIT_NOTE","Klíèová slova"); 
...
define("L_HLP_HDLN_URL",'alias pro URL èlánku<br>(bude nahrazeno buï "URL èlánku" (je-li zaškrtnut "odkaz ven") nebo odkazem na text pøíspìvku)<div class=example><em>Pøíklad: </em>&lt;a href=_#HDLN_URL&gt;_#HEADLINE&lt;/a&gt;</div>');
define("L_HLP_POSTDATE",'alias pro datum zaøazení èlánku');
define("L_HLP_PUB_DATE",'alias pro datum otištìní èlánku');
...
define("L_HLP_EDITNOTE","alias pro klíèová slova");
define("L_HLP_IMGWIDTH",'alias pro šíøku obrázku<br>(pokud není šíøka zadaná, program se pokusí odstranit <em>width=</em> atribut z formátovacího øetìzce<div class=example><em>Pøíklad: </em>&lt;img href="_#IMAGESRC width=_#IMGWIDTH height=_#IMG_HGHT&gt;</div>');
define("L_HLP_IMG_HGHT",'alias pro výšku obrázku<br>(pokud není výška zadaná, program se pokusí odstranit <em>height=</em> atribut z formátovacího øetìzce<div class=example><em>Pøíklad: </em>&lt;img href="_#IMAGESRC width=_#IMGWIDTH height=_#IMG_HGHT&gt;</div>');
...
define("L_D_LISTLEN", "Poèet vypisovaných èlánkù");
define("L_MSG_PAGE", "Zpráva aplikace");   // title of message page
define("L_EDITOR_TITLE", "Správa èlánkù");
define("L_FULLTEXT_FORMAT", "HTML kód textu èlánku");
define("L_A_FULLTEXT_TIT", "Správa webíku - Vzhled èlánku");
define("L_FULLTEXT_HDR", "HTML kód pro zobrazení zprávy");
define("L_A_COMPACT_TIT", "Správa webíku - Vzhled pøehledu èlánkù");
define("L_COMPACT_HDR", "HTML kód pro pøehled èlánkù");
define("L_A_FILTERS_TIT", "Správa webíku - Filtry pro výmìnu èlánkù");
define("L_FLT_SETTING", "Nastavení filtrù pro pøíjem èlánkù");
define("L_FLT_FROM_SL", "Filtr pro pøíjem èlánkù z webíku");
define("L_FLT_APPROVED", "Jako vystavený èlánek");
define("L_ITEM_HDR", "Vstupní formuláø èlánku");
define("L_A_ITEM_ADD", "Pøidat èlánek");
define("L_A_ITEM_EDT", "Upravit èlánek");
define("L_IMP_EXPORT", "Povolit zasílání èlánkù do webíku:");
define("L_EXPORT_TO_ALL", "Povol zasílání èlánkù do jakéhokoliv webíku");
define("L_IMP_IMPORT", "Pøijímat èlánky z webíku:");
define("L_ADD_NEW_ITEM", "Nový èlánek");
define("L_ERR_FEEDED_ITEMS", "V koši je èlánek, který byla zaslán jinému webíku - nemùže být odstranìn.");
define("L_EDIT_ITEMS", "Editace èlánku");
define("L_VIEW_FULLTEXT", "Zobraz èlánek");
define("L_FULLTEXT", "Text èlánku");
define("L_FEEDING", "Výmìna èlánkù");
define("L_HIGHLIGHTED", "Zajímavý èlánek");
define("L_NO_HIGHLIGHTED", "Obyèejná èlánek");
define("L_A_SLICE_IMP", "Správa webíku - Výmìna èlánkù");
define("L_NO_PS_EDIT_ITEMS", "Nemáte právo upravovat èlánky v tomto webíku");
define("L_NO_DELETE_ITEMS", "Nemáte právo mazat èlánky");
define("L_NO_PS_MOVE_ITEMS", "Nemáte právo pøesouvat èlánky");
define("L_NO_PS_COPMPACT", "Nemáte právo upravovat vzhled pøehledu èlánkù");
define("L_NO_PS_FULLTEXT", "Nemáte právo upravovat vzhled èlánku");
define("L_NO_PS_FEEDING", "Nemáte právo mìnit nastavení výmìny èlánkù");
define("L_COMPACT_OK", "Vzhled pøehledu èlánkù byl úspìšnì zmìnìn");
define("L_IMPORT_OK", "Nastavení výmìny èlánkù bylo úspìšnì zmìnìno");
define("L_FULLTEXT_OK", "Vzhled èlánku byl úspìšnì zmìnìn");


# toolkit aplication independent labels (should not be true)

define("L_ACTIVE_BIN", "Vystaveno");
...
define("L_FEED", "Výmìna èlánkù");
define("L_FEEDTO_TITLE", "Pøedat èlánek do webíku");
define("L_FEED_TO", "Pøedat vybrné èlánky do zvolených webíku");
...
define("L_OTHER_ARTICLES", "Ostatní èlánky");
...
define("L_ARTICLE_MANAGER", "Správa èlánkù");
...
Revision 1.12  2000/08/15 08:58:31  kzajicek
...
Revision 1.1.1.1  2000/06/21 18:40:25  madebeer
reimport tree , 2nd try - code works, tricky to install

Revision 1.1.1.1  2000/06/12 21:50:13  madebeer
Initial upload.  Code works, tricky to install. Copyright, GPL notice there.

Revision 1.3  2000/06/12 19:58:34  madebeer
Added copyright (APC) notice to all .inc and .php3 files that have an $Id

Revision 1.2  2000/06/09 15:14:10  honzama
New configurable admin interface

Revision 1.1  2000/05/30 09:15:17  honzama
Initial version.
