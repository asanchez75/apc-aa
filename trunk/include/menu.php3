...
function get_aamenus ()
{
    ...
    */
    ...
    $aamenus ["sliceadmin_submenu"] = array (
        ...
        //"te_emails" => array ("label"=>L_EMAILS, "cond"=>CheckPerms( $auth->auth["uid"], "slice", $slice_id, PS_FULLTEXT), "href"=>"admin/tabledit.php3?set_tview=email&slice_id=$slice_id"), 
        ...
        "rssfeeds"=>array("cond"=>CheckPerms( $auth->auth["uid"], "slice", $slice_id, PS_FEEDING), "href"=>"admin/se_rssfeeds.php3?slice_id=$slice_id", "label"=>L_RSSFEEDS_MANAGER),
