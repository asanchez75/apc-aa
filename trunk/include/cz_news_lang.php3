...
define("L_FEED_TO", "Pøedat vybrané zprávy do zvolených webíku");
...
define("L_ALIAS_FUNC_V", "f_v - pohled");
...
define("L_D_APPROVED_COUNT_ALIAS","Alias pro poèet schválených pøíspìvkù k danému èlánku");
...
define("L_D_BUTTONS","Alias pro tlaèítka Zobraz vše, Zobraz vybrané, Pøidej nový<br>
...
define("L_D_NODISCUS","Žádné diskusní pøíspìvky");
...
define('L_D_SELECTED_NONE',"Nebyl vybrán žádný pøíspìvek");
...
define("L_D_ADD_NEW","Pøidej nový");
...
define("L_INNER_IMPORT","Lokální výmìna");
...
define("L_NODES_NODE_EMPTY","Jméno uzlu musí být vyplnìno");

define("L_IMPORT_TIT","Správa pøijímaných webíkù");
define("L_IMPORT_LIST","Seznam pøijímaných webíkù do webíku ");
...
define("L_IMPORT_SLICES","Seznam pøijímaných webíkù");
define("L_IMPORT_SLICES2","Seznam dostupných webíkù z uzlu ");
...
define("L_E_EXPORT_TEXT_TITLE", "Export struktury webíku - tento text uložte do souboru");
define("L_E_EXPORT_MEMO", "Mùžete exportovat do jiného Toolkitu (export aktuální šablony, zvolíte si nový identifikátor), "
			."nebo do Backupu (export více šablon najednou)");
define("L_E_EXPORT_MEMO_ID","Zvolte nový identifikátor šablony o délce pøesnì 16 znakù: ");
...
define("L_E_EXPORT_CLICK_TEXT","zobrazíte text kódující šablonu. Ten uložte do souboru (buï pomocí Copy a Paste, nebo v Internet Exploreru pomocí Uložit jako) a soubor pak mùžete použít pro import.");
...
define("L_E_EXPORT_TITLE_IDLENGTH", "Délka identifikátoru musí být 16 znakù, a ne ");
...
define("L_E_IMPORT_WRONG_FILE","Text není v poøádku. Zkontrolujte, že jste ho správnì zkopírovali z Exportu.");
