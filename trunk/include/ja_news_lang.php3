...
define("LANG_FILE", "ja_news_lang.php3");
...
define("L_VIEW_SLICE", "サイトを見る");
define( "L_SLICE_HINT", '<br>スライスをあなたのページの一部にするためには 
                         以下のshtmlコードを追加して下さい: ');
define("L_ITEM_ID_ALIAS",'項目 IDの 別名');
...
define("L_A_ITEM_ADD", "項目の追加");
define("L_A_ITEM_EDT", "項目の編集");
define("L_IMP_EXPORT", "Enable export to slice:");
define("L_ADD_NEW_ITEM", "項目の追加");
define("L_DELETE_TRASH", "ゴミ箱を空にする");
define("L_VIEW_FULLTEXT", "Preview");
define("L_FULLTEXT", "全文");
...
define("L_ACTIVE_BIN", "活動中");
define("L_HOLDING_BIN", "保留箱");
define("L_TRASH_BIN", "ゴミ箱");

define("L_CATEGORY","分類");
define("L_SLICE_NAME", "題名");          // slice
define("L_DELETED", "抹消済");           // slice
define("L_D_LISTLEN", "一覧の長さ");  // slice
define("L_ERR_CANT_CHANGE", "Can't change slice settings");
define("L_ODD_ROW_FORMAT", "奇数行");
define("L_EVEN_ROW_FORMAT", "偶数行");
...
define("L_COMPACT_TOP", "先頭のHTML");
define("L_COMPACT_BOTTOM", "最後のHTML");
define("L_A_COMPACT_TIT", "管理 - design Index view");
define("L_A_FILTERS_TIT", "管理 - Content Pooling - Filters");
...
define("L_FLT_TO", "To");
define("L_FLT_APPROVED", "活動中");
define("L_FLT_CATEGORIES", "分類");
define("L_ALL_CATEGORIES", "全ての分類");
...
define("L_ADD", "追加");
define("L_USERS", "利用者群");
define("L_GROUPS", "グループ群");
define("L_SEARCH", "検索");
define("L_DEFAULTS", "省略値");
define("L_SLICE", "スライス");
define("L_DELETED_SLICE", "あなたのスライスが見つかり出来ません");
define("L_A_NEWUSER", "New user in permission system");
define("L_NEWUSER_HDR", "新規利用者");
define("L_USER_LOGIN", "ログイン名");
define("L_USER_PASSWORD1", "パスワード");
define("L_USER_PASSWORD2", "パスワードを繰り返す");
define("L_USER_FIRSTNAME", "名前");
define("L_USER_SURNAME", "姓");
define("L_USER_MAIL", "E-メール");
define("L_USER_SUPER", "超管理者 アカウント");
define("L_A_USERS_TIT", "管理 - 利用者管理");
define("L_A_PERMISSIONS", "管理 - 許可");
define("L_A_ADMIN", "管理 - design 項目管理 view");
define("L_A_ADMIN_TIT", "管理 - design Item Manager view");
define("L_ADMIN_FORMAT", "Item format");
define("L_ADMIN_FORMAT_BOTTOM", "最後の HTML");
define("L_ADMIN_FORMAT_TOP", "先頭の HTML");
...
define("L_ROLE_AUTHOR", "作者");
define("L_ROLE_EDITOR", "編集者");
define("L_ROLE_ADMINISTRATOR", "管理者");
define("L_ROLE_SUPER", "超");

define("L_MAIN_SET", "主な設定");
define("L_PERMISSIONS", "許可");
define("L_PERM_CHANGE", "変更");
define("L_PERM_ASSIGN", "代入");
define("L_PERM_NEW", "利用者かグループの検索");
define("L_PERM_SEARCH", "新しい許可を代入");
define("L_PERM_CURRENT", "現在の許可を変更");
define("L_USER_NEW", "新しい利用者");
define("L_DESIGN", "デザイン");
...
define("L_FIELD_IN_EDIT", "表示");
define("L_NEEDED_FIELD", "必要");
...
define("L_SEARCH_SHOW", "表示");
define("L_SEARCH_DEFAULT", "省略時の設定");
define("L_SEARCH_SET", "検索");
define("L_AND", "AND");
define("L_OR", "OR");
...
define("L_NO_PS_EDIT", "スライスを編集する許可がありません");
define("L_NO_PS_ADD", "スライスを追加する許可がありません");
...
define("L_NEW_SLICE", "スライスを追加");
define("L_ASSIGN", "代入");
define("L_CATBINDS_OK", "分類の更新が成功しました");
...
define("L_NO_CATEGORY", "分類が定義されていません");
define("L_NO_IMPORTED_SLICE", "There are no imported slices");
define("L_NO_USERS", "利用者(グループ)が見付かりません");
...
define("L_LOGO", "APC アクション アプリ");
define("L_USER_MANAGEMENT", "利用者群");
define("L_ITEMS", "項目管理ページ");
define("L_NEW_SLICE_HEAD", "新規スライス");
...
define("L_NO_PERMISSION_TO_FEED", "許可がありません");
define("L_NO_PS_CONFIG", "You have no permission to set configuration parameters of this slice");
define("L_SLICE_CONFIG", "項目管理");
define("L_CHBOX_HEAD", "&nbsp;");   // title of checkbox in admin interface
define("L_CHBOX", "Checkbox"); 
define("L_CATNAME", "分類名");
define("L_CATEGORY_ID", "分類 ID");
define("L_EDITED_BY","編集した人");
define("L_MASTER_ID", "Master id");
define("L_NO_ITEM_FOUND", "項目が見付かりません");
define("L_CHANGE_MARKED", "選択された項目群");
define("L_MOVE_TO_ACTIVE_BIN", "活動中へ移動");
define("L_MOVE_TO_HOLDING_BIN", "保留箱へ移動");
define("L_MOVE_TO_TRASH_BIN", "ゴミ箱に移動");
...
define("L_ARTICLE_MANAGER", "項目管理");
define("L_SWITCH_TO", "Switch to:");
define("L_ADMIN", "Admin");

define("L_NO_PS_NEW_USER", "新しい利用者を作成する許可がありません");
define("L_ALL_GROUPS", "全てのグループ");
define("L_USERS_GROUPS", "利用者のグループ");
...
define("L_NO_GROUPS", "グループが見付かりません");
define("L_GROUP_NAME", "名前");
define("L_GROUP_DESCRIPTION", "記述");
define("L_GROUP_SUPER", "超管理者グループ");
...
define("L_A_UM_USERS_TIT", "利用者管理 - 利用者群");
define("L_A_UM_GROUPS_TIT", "利用者管理 - グループ");
define("L_EDITGROUP_HDR", "グループの編集");
define("L_NEWGROUP_HDR", "新規グループ");
define("L_GROUP_ID", "グループ Id");
define("L_ALL_USERS", "全てのグループ");
define("L_GROUPS_USERS", "グループの利用者");
define("L_POST", "更新");
define("L_POST_PREV", "更新して 見る");
define("L_INSERT_PREV", "挿入して 見る");
define("L_OK", "OK");
define("L_ACTIVE_BIN_EXPIRED", "期限切れ");
define("L_ACTIVE_BIN_PENDING", "待機中");
define("L_ACTIVE_BIN_EXPIRED_MENU", "期限切れ");
define("L_ACTIVE_BIN_PENDING_MENU", "待機中");
