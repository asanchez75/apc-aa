...
# modules/site/index.php3, row 132
$_m["Editor window - item manager"]
  = "";

# modules/site/menu.php3, row 54
# other translations: 
$_m["View site"]
  = "";

# modules/site/menu.php3, row 60, 61
$_m["Code&nbsp Manager"]
  = "";

# modules/site/menu.php3, row 66, 67
$_m["Module Settings"]
  = "";

# modules/site/menu.php3, row 73
# other translations: 
$_m["AA"]
  = "";

# modules/site/menu.php3, row 74
$_m["AA Administration"]
  = "";

# modules/site/moddelete.php3, row 70
