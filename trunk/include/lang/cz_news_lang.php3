...
# other translations: Jako aktuální zprávu
$_m["Active"]
  = "Aktuální";
...
# other translations: Aktuální - Expirované
$_m["Expired"]
  = "Vypršeno";
...
# other translations: Hledání, Vyhledávací formuláø, Search
$_m["Search"]
  = "Vyhledat";
...
# other translations: Nenalezena ádná zpráva
$_m["No item found"]
  = "ádná zpráva";
...
# other translations: Nová zpráva
$_m["Add Item"]
  = "Pøidat zprávu";
...
# other translations: Novı webík, Add Slice
$_m["Add Slice"]
...
# other translations: Nasavení poloek úspìšnì zmìnìno
...
# other translations: Administrace webíku - Menu
...
$_m["HTML code for \"No item found\" message"]
  = "HTML kod namísto zprávy \"Nenalezena ádná zpráva\"";
...
$_m["Use these aliases for database fields"]
  = "Pouij následujítí aliasy databázovıch polí";
