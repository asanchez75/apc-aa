...
if ( !IsSuperadmin() ) {
    MsgPage($sess->url(self_base())."index.php3", _m("You do not have permission to see currently scheduled tasks"));
    exit;
}
...
$zids    = AA_Metabase::queryZids(array('table'=>'toexecute'), $aa_set);
