 ...
 */
    ...
    var $phpthumb_version = '1.7.6-200612101028';
...
//		}
    ...
    function CleanUpCacheDirectory() {
        if (($this->config_cache_maxage > 0) || ($this->config_cache_maxsize > 0) || ($this->config_cache_maxfiles > 0)) {
            ...
            if (empty($CacheDirOldFilesAge)) {
                return true;
            }
            $DeletedKeys = array();
            foreach ($CacheDirOldFilesSize as $oldcachefile => $filesize) {
                ...
                if (($filesize == 0) && ($CacheDirOldFilesAge[$oldcachefile] < $cutofftime)) {
                    $fullfilename = $this->config_cache_directory.DIRECTORY_SEPARATOR.$oldcachefile;
