...
function Importer ($sliceID, $fileName, $separator, $actions, $postedBy, $fire=false, $timeLimit=120, $statusCode = 1, $publishDate = 0, $expiryDate = 0, $maxRowLength = 50000, $endOfLine="", $comment="", $remove="")
{
  global $debug;
  if ($debug) {
