...
define("LANG_FILE", "en_polls_lang.php3");
...
define("L_EDITOR_TITLE", "Polls administration");
define("L_ADMIN_POLLS_SETTINGS","Polls settings");
define("L_ADMIN_POLLS_Design","Polls design");
