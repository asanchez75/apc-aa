...
"hco"=>array("name"=>L_PARAM_WIZARD_INPUT_hco_NAME,
	...
	"params"=>array(
		...
		array("name"=>L_PARAM_WIZARD_INPUT_hco_PAR4_NAME,
		"desc"=>L_PARAM_WIZARD_INPUT_hco_PAR4_DESC,
		"type"=>"INT",
		"example"=>L_PARAM_WIZARD_INPUT_hco_PAR4_EXAMPLE),
   		array("name"=>L_PARAM_WIZARD_INPUT_hco_PAR5_NAME,
		"desc"=>L_PARAM_WIZARD_INPUT_hco_PAR5_DESC,
		"type"=>"TEXT",
		"example"=>L_PARAM_WIZARD_INPUT_hco_PAR5_EXAMPLE))),
...
"edt"=>array("name"=>L_PARAM_WIZARD_INPUT_edt_NAME,
	...
	"params"=>array(
		...
		"example"=>L_PARAM_WIZARD_INPUT_edt_PAR1_EXAMPLE),
   		array("name"=>L_PARAM_WIZARD_INPUT_edt_PAR2_NAME,
		"desc"=>L_PARAM_WIZARD_INPUT_edt_PAR2_DESC,
		"type"=>"TEXT",
		"example"=>L_PARAM_WIZARD_INPUT_edt_PAR2_EXAMPLE))),
...
"pre"=>array("name"=>L_PARAM_WIZARD_INPUT_pre_NAME,
	...
	"params"=>array(
		...
		array("name"=>L_PARAM_WIZARD_INPUT_pre_PAR6_NAME,
		"desc"=>L_PARAM_WIZARD_INPUT_pre_PAR6_DESC,
		"type"=>"BOOL",
		"example"=>L_PARAM_WIZARD_INPUT_pre_PAR6_EXAMPLE))),
"tpr"=>array("name"=>L_PARAM_WIZARD_INPUT_tpr_NAME,
	"desc"=>L_PARAM_WIZARD_INPUT_tpr_DESC,
	"params"=>array(
		array("name"=>L_PARAM_WIZARD_INPUT_tpr_PAR0_NAME,
		"desc"=>L_PARAM_WIZARD_INPUT_tpr_PAR0_DESC,
		"type"=>"INT",
		"example"=>L_PARAM_WIZARD_INPUT_tpr_PAR0_EXAMPLE),
		array("name"=>L_PARAM_WIZARD_INPUT_tpr_PAR1_NAME,
		"desc"=>L_PARAM_WIZARD_INPUT_tpr_PAR1_DESC,
		"type"=>"INT",
		"example"=>L_PARAM_WIZARD_INPUT_tpr_PAR1_EXAMPLE))),
...
"iso"=>array("name"=>L_PARAM_WIZARD_INPUT_iso_NAME,
	...
	"params"=>array(
		...
		array("name"=>L_PARAM_WIZARD_INPUT_iso_PAR1_NAME,
		"desc"=>L_PARAM_WIZARD_INPUT_iso_PAR1_DESC,
		"type"=>"STR",
		"example"=>L_PARAM_WIZARD_INPUT_iso_PAR1_EXAMPLE),
		array("name"=>L_PARAM_WIZARD_INPUT_iso_PAR2_NAME,
...
"f_c"=>array("name"=>L_PARAM_WIZARD_FUNC_F_C_NAME,
	...
	"params"=>array(
		...
		array("name"=>L_PARAM_WIZARD_FUNC_F_C_PAR5_NAME,
		"desc"=>L_PARAM_WIZARD_FUNC_F_C_PAR5_DESC,
		"type"=>"STRID",
		"example"=>L_PARAM_WIZARD_FUNC_F_C_PAR5_EXAMPLE)),
	"examples"=>array(
...
"f_e"=>array("name"=>L_PARAM_WIZARD_FUNC_F_E_NAME,
	...
	"params"=>array(
		array("name"=>L_PARAM_WIZARD_FUNC_F_E_PAR0_NAME,
		"desc"=>L_PARAM_WIZARD_FUNC_F_E_PAR0_DESC,
		"type"=>"STR",
		"example"=>L_PARAM_WIZARD_FUNC_F_E_PAR0_EXAMPLE),
		array("name"=>L_PARAM_WIZARD_FUNC_F_E_PAR1_NAME,
		"desc"=>L_PARAM_WIZARD_FUNC_F_E_PAR1_DESC,
		"type"=>"STR",
		"example"=>L_PARAM_WIZARD_FUNC_F_E_PAR1_EXAMPLE))),
