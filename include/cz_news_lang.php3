...
define("L_INPUT_SHOW_FUNC_F_HLP","Funkce, která se pouije pro zobrazení pole ve vstupním formuláøi. Pro nìkteré typu zobrazení lze pouít parametrù, které následují.");
define("L_INPUT_SHOW_FUNC_C_HLP","Hodnoty, pouité v pøípadì vstupních funkcí SELECT èi RADIO.");
define("L_INPUT_SHOW_FUNC_HLP","Parametr pouitı pro vstupní funkce TEXT (<poèet øádkù>) èi DATE (<minus roky>'<plus roky>'<od teï?>).");
