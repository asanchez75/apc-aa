...
function get_aamenus ()
{
    ...
    */
    ...
    $aamenus["itemmanager_submenu"] = array(
        ...
        "app"=>array ("cond"=> 1, "href"=>"admin/index.php3?Tab=app", "label"=>L_ACTIVE_BIN." (".($item_bin_cnt[1]-$item_bin_cnt_exp-$item_bin_cnt_pend).")"),
        "appb"=>array ("show"=>!$apple_design, "cond" => 1, "href"=>"admin/index.php3?Tab=appb", "label"=>L_ACTIVE_BIN_PENDING_MENU." ($item_bin_cnt_pend)"),
        "appc"=>array ("show"=>!$apple_design, "cond" => 1, "href"=>"admin/index.php3?Tab=appc", "label"=>L_ACTIVE_BIN_EXPIRED_MENU." ($item_bin_cnt_exp)"),
        "hold"=>array ("cond"=> 1, "href"=>"admin/index.php3?Tab=hold", "label"=>L_HOLDING_BIN." ($item_bin_cnt[2])"),
        "trash"=>array ("cond"=> 1, "href"=>"admin/index.php3?Tab=trash", "label"=>L_TRASH_BIN." ($item_bin_cnt[3])"),
        "header2" => L_MISC,
