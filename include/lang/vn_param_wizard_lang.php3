...
# admin/param_wizard.php3, row 77
$_m["Wizard"]
 = "";

# admin/param_wizard.php3, row 162
$_m["This is an undocumented %s. We don't recommend to use it."]
 = "";

# admin/param_wizard.php3, row 163
$_m["Close the wizard"]
 = "";

# admin/param_wizard.php3, row 177
...
# admin/param_wizard.php3, row 190
$_m["any&nbsp;text"]
 = "";

# admin/param_wizard.php3, row 191
$_m["field&nbsp;id"]
 = "";

# admin/param_wizard.php3, row 192
$_m["boolean:&nbsp;0=false,1=true"]
 = "";

# admin/param_wizard.php3, row 205
$_m["This %s has no parameters."]
 = "";

# admin/param_wizard.php3, row 215
$_m["Have a look at these examples of parameters sets:"]
 = "";

# admin/param_wizard.php3, row 222
$_m["Show"]
 = "";

# admin/param_wizard.php3, row 232
$_m["OK - Save"]
 = "";

# admin/param_wizard.php3, row 233
$_m["Cancel"]
 = "";
...
# admin/param_wizard.php3, row 236
$_m["OK"]
 = "";
...
# include/constants_param_wizard.php3, row 60
$_m["Does not modify the value (just like Text), but it is better to separate it for future ussage."]
 = "";
...
# include/constants_param_wizard.php3, row 82
$_m["Upload policy"]
 = "";
...
# include/constants_param_wizard.php3, row 90
$_m["Exact dimensions"]
 = "";
...
# include/constants_param_wizard.php3, row 100, 132
$_m["Login name"]
 = "";
...
# include/constants_param_wizard.php3, row 104
...
# include/constants_param_wizard.php3, row 107, 209, 652
...
# include/constants_param_wizard.php3, row 116
...
# include/constants_param_wizard.php3, row 130
$_m["User ID"]
 = "";
...
# include/constants_param_wizard.php3, row 145
$_m["Field to check"]
 = "";

# include/constants_param_wizard.php3, row 147
$_m["If you need a unique code, you must send the field ID,\n"
   ."                  the function will then look into this field to ensure uniqueness."]
 = "";

# include/constants_param_wizard.php3, row 150, 202
$_m["Slice only"]
 = "";

# include/constants_param_wizard.php3, row 152, 204
...
# include/constants_param_wizard.php3, row 165
$_m["E-mail"]
 = "";
...
# include/constants_param_wizard.php3, row 173
...
# include/constants_param_wizard.php3, row 181, 198
$_m["Field ID"]
 = "";

# include/constants_param_wizard.php3, row 182, 199
...
# include/constants_param_wizard.php3, row 196
...
# include/constants_param_wizard.php3, row 225
$_m["Level count"]
 = "";
...
# include/constants_param_wizard.php3, row 237
$_m["Horizontal"]
 = "";
...
# include/constants_param_wizard.php3, row 241
$_m["First selectable"]
 = "";
...
# include/constants_param_wizard.php3, row 253, 261
$_m["row count"]
 = "";
...
# include/constants_param_wizard.php3, row 265
$_m["column count"]
 = "";

# include/constants_param_wizard.php3, row 269, 787
...
# include/constants_param_wizard.php3, row 277, 341
$_m["max characters"]
 = "";
...
# include/constants_param_wizard.php3, row 281, 345
$_m["width"]
 = "";
...
# include/constants_param_wizard.php3, row 290, 570
$_m["Show Actions"]
 = "";
...
# include/constants_param_wizard.php3, row 299, 501, 550, 610
$_m["Row count"]
 = "";

# include/constants_param_wizard.php3, row 300
$_m["Number of rows (values) displayed at once"]
 = "";

# include/constants_param_wizard.php3, row 306
$_m["Select Box"]
 = "";
...
# include/constants_param_wizard.php3, row 309, 349
$_m["slice field"]
 = "";

# include/constants_param_wizard.php3, row 310, 350, 506
...
# include/constants_param_wizard.php3, row 312, 352, 416, 475, 508, 625, 913
$_m["category........"]
 = "";

# include/constants_param_wizard.php3, row 313, 353
$_m["use name"]
 = "";

# include/constants_param_wizard.php3, row 314, 354
$_m["if set (=1), then the name of selected constant is used, insted of the value. Default is 0"]
 = "";

# include/constants_param_wizard.php3, row 317, 369, 417, 476, 509, 626
...
# include/constants_param_wizard.php3, row 328, 380, 428, 487, 520, 637
...
# include/constants_param_wizard.php3, row 332, 384, 432, 491, 524, 641
$_m["Sort by"]
 = "";

# include/constants_param_wizard.php3, row 333, 385, 433, 492, 525, 642
...
# include/constants_param_wizard.php3, row 357
$_m["adding"]
 = "";
...
# include/constants_param_wizard.php3, row 364, 862
$_m["source_href....."]
 = "";
...
# include/constants_param_wizard.php3, row 397
$_m["cols"]
 = "";
...
# include/constants_param_wizard.php3, row 405, 464
$_m["Columns"]
 = "";
...
# include/constants_param_wizard.php3, row 409, 468
$_m["Move right"]
 = "";

# include/constants_param_wizard.php3, row 410, 469
$_m["Should the function move right or down to the next value?"]
 = "";

# include/constants_param_wizard.php3, row 413, 472, 505, 600, 622
$_m["Slice field"]
 = "";
...
# include/constants_param_wizard.php3, row 543
...
# include/constants_param_wizard.php3, row 547
...
# include/constants_param_wizard.php3, row 561, 569
$_m["AMB"]
 = "";
...
# include/constants_param_wizard.php3, row 592
...
# include/constants_param_wizard.php3, row 707, 734, 925
$_m["full_text......."]
 = "";
...
# include/constants_param_wizard.php3, row 718, 801
$_m["link_only......."]
 = "";
...
# include/constants_param_wizard.php3, row 724, 803
...
# include/constants_param_wizard.php3, row 726, 805
...
# include/constants_param_wizard.php3, row 731
$_m["condition field"]
 = "";

# include/constants_param_wizard.php3, row 732
...
# include/constants_param_wizard.php3, row 736, 883
$_m["additional text to the \"\\<a\\>\" tag"]
 = "";

# include/constants_param_wizard.php3, row 738, 885
$_m["target=_blank"]
 = "";

# include/constants_param_wizard.php3, row 739, 806
$_m["no session id"]
 = "";

# include/constants_param_wizard.php3, row 740, 807
$_m["If 1, the session id (AA_SL_Session=...) is not added to url"]
 = "";

# include/constants_param_wizard.php3, row 743, 746
$_m["condition"]
 = "";
...
# include/constants_param_wizard.php3, row 747
$_m["you may use \"!\" to reverse (negate) the condition"]
 = "";

# include/constants_param_wizard.php3, row 750, 866
$_m["begin"]
 = "";
...
# include/constants_param_wizard.php3, row 762
$_m["cond_field"]
 = "";
...
# include/constants_param_wizard.php3, row 766
$_m["skip_the_field"]
 = "";

# include/constants_param_wizard.php3, row 767
...
# include/constants_param_wizard.php3, row 790
$_m["edit"]
 = "";
...
# include/constants_param_wizard.php3, row 794
$_m["/mysite.shtml"]
 = "";
...
# include/constants_param_wizard.php3, row 824
$_m["information"]
 = "";
...
# include/constants_param_wizard.php3, row 843
$_m["count"]
 = "";
...
# include/constants_param_wizard.php3, row 857
...
# include/constants_param_wizard.php3, row 901
$_m["older text"]
 = "";
...
# include/constants_param_wizard.php3, row 904, 953
$_m[""]
 = "";
...
# include/constants_param_wizard.php3, row 906
...
# include/constants_param_wizard.php3, row 910
$_m["stringToMatch"]
 = "";
...
# include/constants_param_wizard.php3, row 917
...
# include/constants_param_wizard.php3, row 921
$_m["headline........"]
 = "";

# include/constants_param_wizard.php3, row 922
$_m["fieldToReturn"]
 = "";
...
# include/constants_param_wizard.php3, row 928, 931, 1037
$_m["default"]
 = "";
...
# include/constants_param_wizard.php3, row 941
...
# include/constants_param_wizard.php3, row 955
...
# include/constants_param_wizard.php3, row 957, 965, 973, 981, 989, 997, 1005, 1013, 1021, 1029
$_m["content"]
 = "";
...
# include/constants_param_wizard.php3, row 962, 970, 978, 986, 994, 1002, 1010, 1018, 1026, 1034
$_m["string to return if previous content matches - You can use field_id too"]
 = "";

# include/constants_param_wizard.php3, row 964, 972, 980, 988, 996, 1004, 1012, 1020, 1028, 1036
$_m["Environment"]
 = "";
...
# include/constants_param_wizard.php3, row 1047
$_m["usr_start_end_date_cz"]
 = "";

# include/constants_param_wizard.php3, row 1048
$_m["parameter"]
 = "";
...
# include/constants_param_wizard.php3, row 1058
$_m["vid=4&amp;cmd[23]=v-25"]
 = "";

# include/constants_param_wizard.php3, row 1059
$_m["image width"]
 = "";

# include/constants_param_wizard.php3, row 1060
...
# include/constants_param_wizard.php3, row 1067
$_m["Store"]
 = "";

# include/constants_param_wizard.php3, row 1068
$_m["Simply store a value from the input field"]
 = "";

# include/constants_param_wizard.php3, row 1072
$_m["Remove string"]
 = "";
...
# include/constants_param_wizard.php3, row 1075, 1093, 1110
$_m["string parameter"]
 = "";

# include/constants_param_wizard.php3, row 1076
$_m["Removed string"]
 = "";

# include/constants_param_wizard.php3, row 1080
$_m["Format date"]
 = "";

# include/constants_param_wizard.php3, row 1081
$_m["Parse the date in the input field expected to be in English date format. In case of error, the transformation fails"]
 = "";

# include/constants_param_wizard.php3, row 1085
$_m["Add http prefix"]
 = "";

# include/constants_param_wizard.php3, row 1086
$_m["Adds 'http://' prefix to the field if not beginning with 'http://' and not empty."]
 = "";

# include/constants_param_wizard.php3, row 1090
$_m["Store parameter"]
 = "";

# include/constants_param_wizard.php3, row 1091
...
# include/constants_param_wizard.php3, row 1107
