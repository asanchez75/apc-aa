...
# modules/links/constants.php3, row 98
$_m["Change"]
  = "";

# modules/links/linkedit.php3, row 65
# modules/links/menu.php3, row 77, 78
$_m["Edit Link"]
  = "";

# modules/links/linkedit.php3, row 73
# modules/links/menu.php3, row 77
$_m["Add Link"]
  = "";
...
# modules/links/linkedit.php3, row 285, 320
$_m["Proposal to add"]
  = "";

# modules/links/linkedit.php3, row 287, 307
$_m["Proposal to del"]
  = "";

# modules/links/linkedit.php3, row 347
$_m["APC ActionApps"]
  = "";
...
# modules/links/constants.php3, row 53, 147
$_m["Id"]
  = "";
...
# modules/links/linkedit.php3, row 391
...
# modules/links/constants.php3, row 56, 151
$_m["Description"]
  = "";
...
# modules/links/linkedit.php3, row 400
# modules/links/linkedit2.php3, row 32
# modules/links/constants.php3, row 57, 107
$_m["Link type"]
  = "";
...
# modules/links/catedit2.php3, row 223
...
# modules/links/linkedit.php3, row 411, 412, 413
$_m["n/j/Y"]
  = "";
...
# modules/links/catedit.php3, row 106
$_m["Category tree"]
  = "";
...
# modules/links/linkedit.php3, row 459
...
# modules/links/linkedit.php3, row 469
...
# modules/links/catedit.php3, row 134
# modules/links/catselect.php3, row 57
$_m["OK"]
  = "";

# modules/links/linkedit.php3, row 487
# modules/links/check_url.php3, row 74, 160
...
# modules/links/catedit.php3, row 68
$_m["APC ActionApps - Category Edit"]
  = "";

# modules/links/catedit.php3, row 82
$_m["Category Edit"]
  = "";
...
# modules/links/catedit2.php3, row 217
# modules/links/constants.php3, row 87, 157
$_m["Category name"]
  = "";

# modules/links/catedit.php3, row 91
# modules/links/catedit2.php3, row 218
# modules/links/constants.php3, row 91, 159
...
# modules/links/catedit.php3, row 108
...
# modules/links/catedit2.php3, row 158
$_m["Category reassigned"]
  = "";

# modules/links/catedit2.php3, row 167
$_m["Subcategory deleted"]
  = "";

# modules/links/catedit2.php3, row 169
...
# modules/links/catedit2.php3, row 220
$_m["First text box"]
  = "";
...
# modules/links/catedit2.php3, row 222
$_m["Banner"]
  = "";
...
# modules/links/catedit2.php3, row 296
$_m["New category created"]
  = "";

# modules/links/catedit2.php3, row 302
$_m["Foreign category assigned"]
  = "";

# modules/links/check_url.php3, row 13, 55
...
# modules/links/check_url.php3, row 19, 140
$_m["APC ActionApps - URL Check"]
  = "";

# modules/links/check_url.php3, row 54, 114
$_m["URL"]
  = "";

# modules/links/check_url.php3, row 55, 118
$_m["In category"]
  = "";
...
# modules/links/index.php3, row 410
$_m["Show Links"]
  = "";

# modules/links/index.php3, row 413
$_m["Edit Category"]
  = "";

# modules/links/index.php3, row 422
...
# modules/links/linkedit2.php3, row 342
$_m["Link change proposal inserted"]
  = "";

# modules/links/linkedit2.php3, row 352
$_m["Link inserted"]
  = "";

# modules/links/linkedit2.php3, row 392
$_m["Link changed"]
  = "";

# modules/links/linkedit2.php3, row 407
...
# modules/links/modedit.php3, row 78, 236
$_m["Start category id"]
  = "";

# modules/links/modedit.php3, row 79, 237
$_m["Tree start id"]
  = "";

# modules/links/modedit.php3, row 80, 238
$_m["Select start id"]
  = "";

# modules/links/modedit.php3, row 81, 239
$_m["Default category template"]
  = "";

# modules/links/modedit.php3, row 82, 240
$_m["Link template"]
  = "";
...
# modules/links/modedit.php3, row 222
$_m["ID"]
  = "";

# modules/links/modedit.php3, row 223
$_m["Title"]
  = "";
...
# modules/links/modedit.php3, row 233
...
# modules/links/constants.php3, row 54, 148
$_m["Name"]
  = "";
...
# modules/links/constants.php3, row 86, 156
$_m["Category id"]
  = "";
...
# modules/links/constants.php3, row 92
$_m["Category editor's note"]
  = "";

# modules/links/constants.php3, row 93
$_m["Base"]
  = "";
...
# modules/links/constants.php3, row 95
$_m["Change proposal"]
  = "";
...
# modules/links/constants.php3, row 104
$_m["Link name"]
  = "";

# modules/links/constants.php3, row 105
...
# modules/links/constants.php3, row 110
...
# modules/links/constants.php3, row 149
$_m["Path"]
  = "";

# modules/links/constants.php3, row 150
$_m["Link Count"]
  = "";

# modules/links/constants.php3, row 152
$_m["Note"]
  = "";
...
# modules/links/cattree.php3, row 229
...
# modules/links/menu.php3, row 84, 85
$_m["Link Manager"]
  = "";

# modules/links/menu.php3, row 91, 92
$_m["Link Admin"]
  = "";

# modules/links/menu.php3, row 99, 100
$_m["AA"]
  = "";
...
# modules/links/menu.php3, row 125
$_m["Trash"]
  = "";
...
# modules/links/menu.php3, row 156
$_m["Links"]
  = "";
...
# modules/links/menu.php3, row 162
$_m["New Category View"]
  = "";

# modules/links/menu.php3, row 165
$_m["New Link View"]
  = "";
