...
# include/constants_param_wizard.php3, row 92, 121
$_m["Login name"]
 = "";
...
# include/constants_param_wizard.php3, row 96
...
# include/constants_param_wizard.php3, row 99, 198, 641
...
# include/constants_param_wizard.php3, row 114
$_m["Text"]
 = "";
...
# include/constants_param_wizard.php3, row 139, 191
$_m["Slice only"]
 = "";

# include/constants_param_wizard.php3, row 141, 193
...
# include/constants_param_wizard.php3, row 170, 187
$_m["Field ID"]
 = "";

# include/constants_param_wizard.php3, row 171, 188
...
# include/constants_param_wizard.php3, row 184
$_m["Unique e-mail"]
 = "";
...
# include/constants_param_wizard.php3, row 242, 250
$_m["row count"]
 = "";
...
# include/constants_param_wizard.php3, row 258, 776
...
# include/constants_param_wizard.php3, row 266, 330
$_m["max characters"]
 = "";
...
# include/constants_param_wizard.php3, row 270, 334
$_m["width"]
 = "";
...
# include/constants_param_wizard.php3, row 279, 559
$_m["Show Actions"]
 = "";
...
# include/constants_param_wizard.php3, row 288, 490, 539, 599
$_m["Row count"]
 = "";

# include/constants_param_wizard.php3, row 289
...
# include/constants_param_wizard.php3, row 298, 338
$_m["slice field"]
 = "";

# include/constants_param_wizard.php3, row 299, 339, 495
...
# include/constants_param_wizard.php3, row 301, 341, 405, 464, 497, 614, 902
$_m["category........"]
 = "";

# include/constants_param_wizard.php3, row 302, 342
$_m["use name"]
 = "";

# include/constants_param_wizard.php3, row 303, 343
$_m["if set (=1), then the name of selected constant is used, insted of the value. Default is 0"]
 = "";

# include/constants_param_wizard.php3, row 306, 358, 406, 465, 498, 615
...
# include/constants_param_wizard.php3, row 318, 370, 418, 477, 510, 627
$_m["(for slices only) Conditions for filtering items in selection. Use conds[] array."]
 = "";

# include/constants_param_wizard.php3, row 321, 373, 421, 480, 513, 630
$_m["Sort by"]
 = "";
...
# include/constants_param_wizard.php3, row 328
...
# include/constants_param_wizard.php3, row 331
...
# include/constants_param_wizard.php3, row 350
$_m["secondfield"]
 = "";
...
# include/constants_param_wizard.php3, row 353, 851
$_m["source_href....."]
 = "";
...
# include/constants_param_wizard.php3, row 380
...
# include/constants_param_wizard.php3, row 394, 453
$_m["Columns"]
 = "";

# include/constants_param_wizard.php3, row 395, 454
$_m["Number of columns. If unfilled, the checkboxes are all on one line. If filled, they are formatted in a table."]
 = "";

# include/constants_param_wizard.php3, row 398, 457
$_m["Move right"]
 = "";

# include/constants_param_wizard.php3, row 399, 458
$_m["Should the function move right or down to the next value?"]
 = "";

# include/constants_param_wizard.php3, row 402, 461, 494, 589, 611
$_m["Slice field"]
 = "";
...
# include/constants_param_wizard.php3, row 550, 558
$_m["AMB"]
 = "";
...
# include/constants_param_wizard.php3, row 696, 723, 914
$_m["full_text......."]
 = "";
...
# include/constants_param_wizard.php3, row 704, 787
$_m["link only"]
 = "";
...
# include/constants_param_wizard.php3, row 707, 790
$_m["link_only......."]
 = "";
...
# include/constants_param_wizard.php3, row 712, 791
$_m["redirect"]
 = "";

# include/constants_param_wizard.php3, row 713, 792
...
# include/constants_param_wizard.php3, row 715, 794
...
# include/constants_param_wizard.php3, row 724, 871
$_m["tag addition"]
 = "";

# include/constants_param_wizard.php3, row 725, 872
$_m["additional text to the \"\\<a\\>\" tag"]
 = "";

# include/constants_param_wizard.php3, row 727, 874
$_m["target=_blank"]
 = "";

# include/constants_param_wizard.php3, row 728, 795
$_m["no session id"]
 = "";

# include/constants_param_wizard.php3, row 729, 796
$_m["If 1, the session id (AA_SL_Session=...) is not added to url"]
 = "";

# include/constants_param_wizard.php3, row 732, 735
$_m["condition"]
 = "";
...
# include/constants_param_wizard.php3, row 739, 855
$_m["begin"]
 = "";
...
# include/constants_param_wizard.php3, row 779
$_m["edit"]
 = "";
...
# include/constants_param_wizard.php3, row 880
...
# include/constants_param_wizard.php3, row 893, 942
$_m[""]
 = "";
...
# include/constants_param_wizard.php3, row 917, 920, 1026
$_m["default"]
 = "";
...
# include/constants_param_wizard.php3, row 940
...
# include/constants_param_wizard.php3, row 944
...
# include/constants_param_wizard.php3, row 946, 954, 962, 970, 978, 986, 994, 1002, 1010, 1018
$_m["content"]
 = "";

# include/constants_param_wizard.php3, row 947, 955, 963, 971, 979, 987, 995, 1003, 1011, 1019
$_m["string for comparison with <i>the field</i> for following return value"]
 = "";

# include/constants_param_wizard.php3, row 950, 958, 966, 974, 982, 990, 998, 1006, 1014, 1022
$_m["return value"]
 = "";

# include/constants_param_wizard.php3, row 951, 959, 967, 975, 983, 991, 999, 1007, 1015, 1023
$_m["string to return if previous content matches - You can use field_id too"]
 = "";

# include/constants_param_wizard.php3, row 953, 961, 969, 977, 985, 993, 1001, 1009, 1017, 1025
$_m["Environment"]
 = "";

# include/constants_param_wizard.php3, row 1027
...
# include/constants_param_wizard.php3, row 1031
...
# include/constants_param_wizard.php3, row 1034
...
# include/constants_param_wizard.php3, row 1054
...
# include/constants_param_wizard.php3, row 1061
$_m["Remove string"]
 = "";
...
# include/constants_param_wizard.php3, row 1064, 1082, 1099
$_m["string parameter"]
 = "";
...
# include/constants_param_wizard.php3, row 1079
$_m["Store parameter"]
 = "";
...
# include/constants_param_wizard.php3, row 1089
$_m["string to add"]
 = "";
...
# include/constants_param_wizard.php3, row 1096
...
# include/constants_param_wizard.php3, row 1118
