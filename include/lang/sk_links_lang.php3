...
# modules/links/catedit.php3, row 86
# modules/links/constants.php3, row 53, 156
# modules/links/linkedit.php3, row 388
# modules/links/.#linkedit.php3.1.3, row 377
# modules/links/.#linkedit.php3.1.9, row 378
$_m["Id"]
  = "";
...
# modules/links/.#linkedit.php3.1.3, row 404
# modules/links/.#linkedit.php3.1.9, row 409
# modules/links/linkedit2.php3-, row 40
$_m["Editor's note"]
  = "";
...
# modules/links/.#linkedit.php3.1.3, row 419
# modules/links/.#linkedit.php3.1.9, row 424
$_m["Category tree"]
  = "";
...
# modules/links/catedit.php3, row 116
$_m["New subcategory"]
  = "";
...
# modules/links/catedit.php3, row 119
$_m["Change state"]
  = "";

# modules/links/catedit.php3, row 122
# modules/links/catselect.php3, row 57
# modules/links/linkedit.php3, row 507
# modules/links/.#linkedit.php3.1.3, row 484
# modules/links/.#linkedit.php3.1.9, row 489
$_m["OK"]
  = "";
...
# modules/links/.#check_url.php3.1.4, row 17, 61
...
# modules/links/.#check_url.php3.1.4, row 60, 120
$_m["URL"]
  = "";

# modules/links/check_url.php3, row 60
# modules/links/.#check_url.php3.1.4, row 61, 124
$_m["In category"]
  = "";

# modules/links/check_url.php3, row 60
# modules/links/.#check_url.php3.1.4, row 61
$_m["Link is not assigned to any category"]
  = "";

# modules/links/check_url.php3, row 74
# modules/links/.#check_url.php3.1.4, row 73, 139
$_m["Page with the specified Url is not in database, yet"]
  = "";

# modules/links/check_url.php3, row 81
# modules/links/linkedit.php3, row 508
# modules/links/.#linkedit.php3.1.3, row 485
# modules/links/.#check_url.php3.1.4, row 80, 166
# modules/links/.#linkedit.php3.1.9, row 490
...
# modules/links/.#linkedit.php3.1.3, row 395
# modules/links/.#linkedit.php3.1.9, row 396
# modules/links/linkedit2.php3-, row 29
$_m["Description"]
  = "";
...
# modules/links/.#linkedit.php3.1.3, row 398
# modules/links/.#linkedit.php3.1.9, row 402
# modules/links/linkedit2.php3-, row 33
$_m["Link type"]
  = "";
...
# modules/links/.#check_url.php3.1.4, row 121
# modules/links/linkedit2.php3-, row 32
$_m["Rate"]
  = "";
...
# modules/links/.#linkedit.php3.1.3, row 463
# modules/links/.#linkedit.php3.1.9, row 468
# modules/links/linkedit2.php3-, row 39
$_m["E-mail"]
  = "";

# modules/links/constants.php3, row 67
# modules/links/linkedit.php3, row 392
# modules/links/linkedit2.php3, row 31
# modules/links/.#linkedit.php3.1.3, row 380
# modules/links/.#linkedit.php3.1.9, row 381
# modules/links/linkedit2.php3-, row 31
$_m["Url"]
  = "";
...
# modules/links/linkedit.php3, row 493
# modules/links/.#linkedit.php3.1.3, row 470
# modules/links/.#linkedit.php3.1.9, row 475
$_m["Language"]
  = "";
...
# modules/links/linkedit.php3, row 32
# modules/links/.#linkedit.php3.1.3, row 32
# modules/links/.#linkedit.php3.1.9, row 32
$_m["Change"]
  = "";
...
# modules/links/.#index.php3.1.5, row 46
$_m["No permissions to edit links"]
  = "";

# modules/links/index.php3, row 268
# modules/links/.#index.php3.1.5, row 268
$_m["Check Link"]
  = "";

# modules/links/index.php3, row 271
# modules/links/.#index.php3.1.5, row 271
$_m["Highlight Link"]
  = "";

# modules/links/index.php3, row 274
# modules/links/.#index.php3.1.5, row 274
$_m["Dehighlight Link"]
  = "";

# modules/links/index.php3, row 277
# modules/links/.#index.php3.1.5, row 277
$_m["Remove from category"]
  = "";

# modules/links/index.php3, row 280
# modules/links/.#index.php3.1.5, row 280
$_m["Move to Active"]
  = "";

# modules/links/index.php3, row 284
# modules/links/.#index.php3.1.5, row 284
$_m["Move to Holding bin"]
  = "";

# modules/links/index.php3, row 288
# modules/links/.#index.php3.1.5, row 288
$_m["Move to Trash"]
  = "";

# modules/links/index.php3, row 291
# modules/links/.#index.php3.1.5, row 291
$_m["Add to category"]
  = "";

# modules/links/index.php3, row 295
# modules/links/.#index.php3.1.5, row 295
$_m["Move to category"]
  = "";
...
# modules/links/.#index.php3.1.5, row 386
$_m["All my links"]
  = "";

# modules/links/index.php3, row 387
# modules/links/.#index.php3.1.5, row 387
$_m["Links to check"]
  = "";

# modules/links/index.php3, row 388
# modules/links/.#index.php3.1.5, row 388
$_m["Last edited"]
  = "";

# modules/links/index.php3, row 412
# modules/links/.#index.php3.1.5, row 412
$_m["Show Links"]
  = "";

# modules/links/index.php3, row 415
# modules/links/.#index.php3.1.5, row 415
$_m["Edit Category"]
  = "";

# modules/links/index.php3, row 424
# modules/links/.#index.php3.1.5, row 424
$_m["Show subtree links"]
  = "";

# modules/links/linkedit.php3, row 65
# modules/links/menu.php3, row 78, 79
# modules/links/.#linkedit.php3.1.3, row 63
# modules/links/.#linkedit.php3.1.9, row 65
$_m["Edit Link"]
  = "";

# modules/links/linkedit.php3, row 72
# modules/links/menu.php3, row 78
# modules/links/.#linkedit.php3.1.3, row 71
# modules/links/.#linkedit.php3.1.9, row 72
$_m["Add Link"]
  = "";

# modules/links/linkedit.php3, row 77
# modules/links/.#linkedit.php3.1.3, row 76
# modules/links/.#linkedit.php3.1.9, row 77
$_m["Link do not exist or the base category is not set"]
  = "";

# modules/links/linkedit.php3, row 236, 254
# modules/links/.#linkedit.php3.1.3, row 234, 252
# modules/links/.#linkedit.php3.1.9, row 235, 253
$_m["Proposal to uncheck"]
  = "";

# modules/links/linkedit.php3, row 237, 255
# modules/links/.#linkedit.php3.1.3, row 235, 253
# modules/links/.#linkedit.php3.1.9, row 236, 254
$_m["Proposal to check"]
  = "";

# modules/links/linkedit.php3, row 285
# modules/links/.#linkedit.php3.1.3, row 283, 318
# modules/links/.#linkedit.php3.1.9, row 284, 319
$_m["Proposal to add"]
  = "";

# modules/links/linkedit.php3, row 287
# modules/links/.#linkedit.php3.1.3, row 285, 305
# modules/links/.#linkedit.php3.1.9, row 286, 306
$_m["Proposal to del"]
  = "";
...
# modules/links/.#linkedit.php3.1.3, row 376
# modules/links/.#linkedit.php3.1.9, row 377
$_m["Link"]
  = "";

# modules/links/linkedit.php3, row 395
# modules/links/.#linkedit.php3.1.3, row 383
# modules/links/.#linkedit.php3.1.9, row 384
$_m["Check url"]
  = "";

# modules/links/linkedit.php3, row 396
# modules/links/menu.php3, row 72
# modules/links/.#linkedit.php3.1.3, row 384
# modules/links/.#linkedit.php3.1.9, row 385
$_m["View"]
  = "";

# modules/links/linkedit.php3, row 397
# modules/links/.#linkedit.php3.1.3, row 385
# modules/links/.#linkedit.php3.1.9, row 386
...
# modules/links/.#linkedit.php3.1.3, row 389
# modules/links/.#linkedit.php3.1.9, row 390
# modules/links/linkedit2.php3-, row 27
$_m["Page name"]
  = "";

# modules/links/linkedit.php3, row 402
# modules/links/.#linkedit.php3.1.3, row 390
# modules/links/.#linkedit.php3.1.9, row 391
$_m["English name of the page"]
  = "";

# modules/links/linkedit.php3, row 404
# modules/links/linkedit2.php3, row 28
# modules/links/.#linkedit.php3.1.3, row 392
# modules/links/.#linkedit.php3.1.9, row 393
# modules/links/linkedit2.php3-, row 28
$_m["Original page name"]
  = "";

# modules/links/linkedit.php3, row 405
# modules/links/.#linkedit.php3.1.3, row 393
# modules/links/.#linkedit.php3.1.9, row 394
$_m["Name of the page in original language"]
  = "";

# modules/links/linkedit.php3, row 408
# modules/links/.#linkedit.php3.1.3, row 396
# modules/links/.#linkedit.php3.1.9, row 397
...
# modules/links/.#linkedit.php3.1.3, row 399
# modules/links/.#linkedit.php3.1.9, row 403
$_m["Select the type, if the link belongs to some special category"]
  = "";

# modules/links/linkedit.php3, row 418
# modules/links/.#linkedit.php3.1.3, row 402
# modules/links/.#linkedit.php3.1.9, row 407
$_m["Author's e-mail"]
  = "";

# modules/links/linkedit.php3, row 421
# modules/links/.#linkedit.php3.1.3, row 405
# modules/links/.#linkedit.php3.1.9, row 410
$_m["You can type any message here - it is never shown on the website"]
  = "";

# modules/links/linkedit.php3, row 425
# modules/links/.#linkedit.php3.1.3, row 409
# modules/links/.#linkedit.php3.1.9, row 414
$_m["Last checked"]
  = "";

# modules/links/linkedit.php3, row 425, 426, 427
# modules/links/.#linkedit.php3.1.3, row 409, 410, 411
# modules/links/.#linkedit.php3.1.9, row 414, 415, 416
$_m["n/j/Y"]
  = "";

# modules/links/linkedit.php3, row 426
# modules/links/.#linkedit.php3.1.3, row 410
# modules/links/.#linkedit.php3.1.9, row 415
$_m["Last changed"]
  = "";

# modules/links/linkedit.php3, row 427
# modules/links/.#linkedit.php3.1.3, row 411
# modules/links/.#linkedit.php3.1.9, row 416
$_m["Inserted"]
  = "";

# modules/links/linkedit.php3, row 429
# modules/links/.#linkedit.php3.1.3, row 413
# modules/links/.#linkedit.php3.1.9, row 418
$_m["Show in category"]
  = "";
...
# modules/links/.#linkedit.php3.1.9, row 457
$_m["Organization"]
  = "";

# modules/links/linkedit.php3, row 476
# modules/links/linkedit2.php3, row 34
# modules/links/.#linkedit.php3.1.3, row 453
# modules/links/.#linkedit.php3.1.9, row 458
# modules/links/linkedit2.php3-, row 34
$_m["City"]
  = "";
...
# modules/links/.#linkedit.php3.1.3, row 455
# modules/links/.#linkedit.php3.1.9, row 460
# modules/links/linkedit2.php3-, row 35
$_m["Street"]
  = "";
...
# modules/links/.#linkedit.php3.1.3, row 457
# modules/links/.#linkedit.php3.1.9, row 462
# modules/links/linkedit2.php3-, row 36
$_m["Post code"]
  = "";

# modules/links/linkedit.php3, row 482
# modules/links/linkedit2.php3, row 37
# modules/links/.#linkedit.php3.1.3, row 459
# modules/links/.#linkedit.php3.1.9, row 464
# modules/links/linkedit2.php3-, row 37
$_m["Phone"]
  = "";

# modules/links/linkedit.php3, row 484
# modules/links/linkedit2.php3, row 38
# modules/links/.#linkedit.php3.1.3, row 461
# modules/links/.#linkedit.php3.1.9, row 466
# modules/links/linkedit2.php3-, row 38
$_m["Fax"]
  = "";

# modules/links/linkedit.php3, row 490
# modules/links/.#linkedit.php3.1.3, row 467
# modules/links/.#linkedit.php3.1.9, row 472
$_m["Regions and languages"]
  = "";

# modules/links/linkedit.php3, row 492
# modules/links/.#linkedit.php3.1.3, row 469
# modules/links/.#linkedit.php3.1.9, row 474
$_m["Region"]
  = "";
...
# modules/links/linkedit2.php3, row 346
# modules/links/linkedit2.php3-, row 348
$_m["Link change proposal inserted"]
  = "";

# modules/links/linkedit2.php3, row 356
# modules/links/linkedit2.php3-, row 358
$_m["Link inserted"]
  = "";

# modules/links/linkedit2.php3, row 397
# modules/links/linkedit2.php3-, row 399
$_m["Link changed"]
  = "";

# modules/links/linkedit2.php3, row 413
# modules/links/linkedit2.php3-, row 415
...
# modules/links/actions.php3.bak, row 124, 194
# modules/links/actions.php3, row 124, 194
$_m["Can't get asociation informations"]
  = "";

# modules/links/actions.php3.bak, row 159
...
# modules/links/getcat.php3, row 57
$_m["Select category"]
  = "";
...
# modules/links/info.php3, row 116
$_m["No permissions to info page"]
  = "";

# modules/links/.#check_url.php3.1.4, row 132
$_m["Page is already in database"]
  = "";

# modules/links/.#check_url.php3.1.4, row 134
