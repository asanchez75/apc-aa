...
# include/constants_param_wizard.php3, row 52
$_m["Insert Function"]
  = "";
...
# include/constants_param_wizard.php3, row 82, 111
$_m["Login name"]
  = "";
...
# include/constants_param_wizard.php3, row 89, 185, 430
...
# include/constants_param_wizard.php3, row 129, 164, 178
$_m["Slice only"]
  = "";

# include/constants_param_wizard.php3, row 131, 166, 180
$_m["Do you want to check for uniqueness this slice only 
\n"
   ."                  or all slices?"]
  = "";

# include/constants_param_wizard.php3, row 138
...
# include/constants_param_wizard.php3, row 160, 174
$_m["Field ID"]
  = "";

# include/constants_param_wizard.php3, row 161, 175
...
# include/constants_param_wizard.php3, row 221
$_m["Level names"]
  = "";
...
# include/constants_param_wizard.php3, row 224
...
# include/constants_param_wizard.php3, row 229, 237
$_m["row count"]
  = "";
...
# include/constants_param_wizard.php3, row 245, 565
...
# include/constants_param_wizard.php3, row 253, 281
$_m["max characters"]
  = "";
...
# include/constants_param_wizard.php3, row 257, 285
$_m["width"]
  = "";
...
# include/constants_param_wizard.php3, row 265, 289
$_m["slice field"]
  = "";

# include/constants_param_wizard.php3, row 266, 290
...
# include/constants_param_wizard.php3, row 268, 292, 670
$_m["category........"]
  = "";

# include/constants_param_wizard.php3, row 269, 293
$_m["use name"]
  = "";

# include/constants_param_wizard.php3, row 270, 294
$_m["if set (=1), then the name of selected constant is used, insted of the value. Default is 0"]
  = "";

# include/constants_param_wizard.php3, row 273
$_m["show all"]
  = "";
...
# include/constants_param_wizard.php3, row 286
...
# include/constants_param_wizard.php3, row 301
$_m["secondfield"]
  = "";
...
# include/constants_param_wizard.php3, row 304, 623
$_m["source_href....."]
  = "";

# include/constants_param_wizard.php3, row 305
$_m["add2constant"]
  = "";
...
# include/constants_param_wizard.php3, row 310
...
# include/constants_param_wizard.php3, row 313
$_m["rows"]
  = "";

# include/constants_param_wizard.php3, row 314
$_m["Textarea rows"]
  = "";

# include/constants_param_wizard.php3, row 317
$_m["cols"]
  = "";
...
# include/constants_param_wizard.php3, row 325, 360
$_m["Columns"]
  = "";

# include/constants_param_wizard.php3, row 326, 361
$_m["Number of columns. If unfilled, the checkboxes are all on one line. If filled, they are formatted in a table."]
  = "";

# include/constants_param_wizard.php3, row 329, 364
$_m["Move right"]
  = "";

# include/constants_param_wizard.php3, row 330, 365
...
# include/constants_param_wizard.php3, row 341
$_m["Ending Year"]
  = "";
...
# include/constants_param_wizard.php3, row 369
...
# include/constants_param_wizard.php3, row 372, 396, 412
$_m["Row count"]
  = "";

# include/constants_param_wizard.php3, row 377
$_m["File"]
  = "";
...
# include/constants_param_wizard.php3, row 385
...
# include/constants_param_wizard.php3, row 401
...
# include/constants_param_wizard.php3, row 405
...
# include/constants_param_wizard.php3, row 410
...
# include/constants_param_wizard.php3, row 485, 512, 682
$_m["full_text......."]
  = "";
...
# include/constants_param_wizard.php3, row 493, 576
$_m["link only"]
  = "";

# include/constants_param_wizard.php3, row 494
...
# include/constants_param_wizard.php3, row 496, 579
$_m["link_only......."]
  = "";

# include/constants_param_wizard.php3, row 497
$_m["url_field"]
  = "";
...
# include/constants_param_wizard.php3, row 501, 580
$_m["redirect"]
  = "";

# include/constants_param_wizard.php3, row 502, 581
...
# include/constants_param_wizard.php3, row 504, 583
...
# include/constants_param_wizard.php3, row 513, 643
$_m["tag addition"]
  = "";

# include/constants_param_wizard.php3, row 514, 644
$_m["additional text to the \"\\<a\\>\" tag"]
  = "";

# include/constants_param_wizard.php3, row 516, 646
$_m["target=_blank"]
  = "";

# include/constants_param_wizard.php3, row 517, 584
$_m["no session id"]
  = "";

# include/constants_param_wizard.php3, row 518, 585
$_m["If 1, the session id (AA_SL_Session=...) is not added to url"]
  = "";

# include/constants_param_wizard.php3, row 521, 524
$_m["condition"]
  = "";
...
# include/constants_param_wizard.php3, row 528, 627
$_m["begin"]
  = "";
...
# include/constants_param_wizard.php3, row 631
$_m["field/text"]
  = "";
...
# include/constants_param_wizard.php3, row 685, 688, 782
$_m["default"]
  = "";
...
# include/constants_param_wizard.php3, row 702, 710, 718, 726, 734, 742, 750, 758, 766, 774
$_m["content"]
  = "";

# include/constants_param_wizard.php3, row 703, 711, 719, 727, 735, 743, 751, 759, 767, 775
$_m["string for comparison with <i>the field</i> for following return value"]
  = "";

# include/constants_param_wizard.php3, row 706, 714, 722, 730, 738, 746, 754, 762, 770, 778
$_m["return value"]
  = "";

# include/constants_param_wizard.php3, row 707, 715, 723, 731, 739, 747, 755, 763, 771, 779
$_m["string to return if previous content matches - You can use field_id too"]
  = "";

# include/constants_param_wizard.php3, row 709, 717, 725, 733, 741, 749, 757, 765, 773, 781
$_m["Environment"]
  = "";
...
# include/constants_param_wizard.php3, row 786
$_m["user function"]
  = "";
