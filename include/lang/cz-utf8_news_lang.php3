<?php
# $Id: cz_news_lang.php3 2590 2008-01-18 16:29:46Z honzam $
# Language: CZ
...
$_m["It is impossible to add user to permission system"]
 = "Nepodařilo se přidat uživatele do systému - chyba LDAP";
...
$_m["e.g. http://www.someplace.com/rss/index.xml"]
 = "např: http://www.someplace.com/rss/index.xml";
