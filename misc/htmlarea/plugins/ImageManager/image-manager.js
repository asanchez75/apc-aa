...
{
//  'backend'    : Xinha.getPluginDir("ImageManager") + '/backend.php?__plugin=ImageManager&',                               // AA_CHANGE - honzam
  'backend'    : Xinha.getPluginDir("ImageManager") + '/backend.php?AA_CP_Session='+aa_session+'&__plugin=ImageManager&',    // AA_CHANGE + honzam
  'backend_data' : null,
