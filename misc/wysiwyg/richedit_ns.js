 ...
 var cont = PropertyAccessor.Get(obj_ed,"DocumentHTML");; 
 var texto = "" + cont 
 ...
 var obj_ed = eval(nom_editor); 
 PropertyAccessor.Set(obj_ed,"DocumentHTML",contingut);;
 } 
 ...
 var NR = PropertyAccessor.Get(pVar,"NumRows");; 
 var NC = PropertyAccessor.Get(pVar,"NumCols");; 
 var TA = PropertyAccessor.Get(pVar,"TableAttrs");; 
 var CA = PropertyAccessor.Get(pVar,"CellAttrs");; 
 ...
 var pVar = ObjTableInfo; 
 PropertyAccessor.Set(pVar,"NumRows",nf);; 
 PropertyAccessor.Set(pVar,"NumCols",nc);; 
 PropertyAccessor.Set(pVar,"TableAttrs",at);; 
 PropertyAccessor.Set(pVar,"CellAttrs",ac);; 
